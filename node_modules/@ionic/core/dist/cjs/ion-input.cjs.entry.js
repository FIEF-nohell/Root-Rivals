...
const index = require('./index-5307fcb0.js');
const index$1 = require('./index-b0e73ba0.js');
const ionicGlobal = require('./ionic-global-52e74ea6.js');
const formController = require('./form-controller-d42b8c05.js');
const helpers = require('./helpers-77560954.js');
const index$2 = require('./index-79605113.js');
const theme = require('./theme-e6fec71e.js');
const input_utils = require('./input.utils-c12d9f8d.js');
...
const Input = class {
  ...
  renderLabelContainer() {
    ...
    if (hasOutlineFill) {
       ...
       */
      return [
        index.h("div", { class: "input-outline-container" }, index.h("div", { class: "input-outline-start" }), index.h("div", { class: "input-outline-notch" }, index.h("div", { class: "notch-spacer", "aria-hidden": "true" }, this.label)), index.h("div", { class: "input-outline-end" })),
        this.renderLabel(),
      ];
    }
    /**

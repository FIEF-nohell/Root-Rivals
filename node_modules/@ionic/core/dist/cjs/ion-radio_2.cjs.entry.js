...
const Radio = class {
  ...
  renderRadio() {
    ...
    return (index.h(index.Host, { onClick: this.onClick, class: theme.createColorClasses(color, {
      ...
      }) }, index.h("label", { class: "radio-wrapper" }, index.h("input", Object.assign({ type: "radio", checked: checked, disabled: disabled, id: inputId, ref: (nativeEl) => (this.nativeInput = nativeEl) }, inheritedAttributes)), index.h("div", { class: {

...
const hardwareBackButton = require('./hardware-back-button-bae6e13a.js');
...
const createTriggerController = () => {
  ...
  const addClickListener = (el, trigger) => {
    ...
    if (!triggerEl) {
      index.printIonWarning(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on an overlay component.`, el);
      return;
    }

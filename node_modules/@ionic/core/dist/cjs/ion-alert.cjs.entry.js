...
const config = require('./config-172736e4.js');
const buttonActive = require('./button-active-f7e83624.js');
...
require('./haptic-0de31202.js');
require('./index-def9efb5.js');
require('./gesture-controller-e2865472.js');
require('./framework-delegate-d2bbe945.js');
require('./helpers-77560954.js');
...
const Alert = class {
  ...
  async present() {
    ...
    this.currentTransition = overlays.present(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
    await this.currentTransition;
  ...
  async dismiss(data, role) {
    this.currentTransition = overlays.dismiss(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  ...
  renderAlertButtons() {
    ...
    return (index.h("div", { class: alertButtonGroupClass }, buttons.map((button) => (index.h("button", { type: "button", id: button.id, class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, index.h("span", { class: "alert-button-inner" }, button.text), mode === 'md' && index.h("ion-ripple-effect", null))))));
  }

...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
  ...
  renderLabelContainer() {
    ...
    if (hasOutlineFill) {
       ...
       */
      return [
        index.h("div", { class: "textarea-outline-container" }, index.h("div", { class: "textarea-outline-start" }), index.h("div", { class: "textarea-outline-notch" }, index.h("div", { class: "notch-spacer", "aria-hidden": "true" }, this.label)), index.h("div", { class: "textarea-outline-end" })),
        this.renderLabel(),
      ];
    }
    /**

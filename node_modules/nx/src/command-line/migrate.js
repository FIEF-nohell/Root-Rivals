    ...
    return function nxMigrateFetcher(packageName, packageVersion) {
        ...
        migrations = fetchMigrations(packageName, packageVersion, setCache).then((result) => {
            if (result.schematics) {
                result.generators = Object.assign(Object.assign({}, result.schematics), result.generators);
...
function getPackageMigrationsConfigFromRegistry(packageName, packageVersion) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const result = yield (0, package_manager_1.packageRegistryView)(packageName, packageVersion, 'nx-migrations ng-update dist --json');
        if (!result) {
            return null;
        }
        const json = JSON.parse(result);
        if (!json['nx-migrations'] && !json['ng-update']) {
            const registry = new url_1.URL('dist' in json ? json.dist.tarball : json.tarball)
                .hostname;
...
function readNxVersion(packageJson) {
    ...
    return ((_k = (_h = (_f = (_d = (_b = (_a = packageJson === null || packageJson === void 0 ? void 0 : packageJson.devDependencies) === null || _a === void 0 ? void 0 : _a['nx']) !== null && _b !== void 0 ? _b : (_c = packageJson === null || packageJson === void 0 ? void 0 : packageJson.dependencies) === null || _c === void 0 ? void 0 : _c['nx']) !== null && _d !== void 0 ? _d : (_e = packageJson === null || packageJson === void 0 ? void 0 : packageJson.devDependencies) === null || _e === void 0 ? void 0 : _e['@nx/workspace']) !== null && _f !== void 0 ? _f : (_g = packageJson === null || packageJson === void 0 ? void 0 : packageJson.dependencies) === null || _g === void 0 ? void 0 : _g['@nx/workspace']) !== null && _h !== void 0 ? _h : (_j = packageJson === null || packageJson === void 0 ? void 0 : packageJson.devDependencies) === null || _j === void 0 ? void 0 : _j['@nrwl/workspace']) !== null && _k !== void 0 ? _k : (_l = packageJson === null || packageJson === void 0 ? void 0 : packageJson.dependencies) === null || _l === void 0 ? void 0 : _l['@nrwl/workspace']);
}
        ...
        for (const m of migrations) {
            try {
                ...
                if (!isAngularMigration(collection, collectionPath, m.name)) {
                    const changes = yield runNxMigration(root, collectionPath, collection, m.name);
                    if (changes.length < 1) {
                    ...
                    const ngCliAdapter = yield getNgCompatLayer();
...
function runNxMigration(root, collectionPath, collection, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function readMigrationCollection(packageName, root) {
    ...
    (_a = collection.name) !== null && _a !== void 0 ? _a : (collection.name = packageName);
    return {
        collection,
        collectionPath,
    };
...
function getImplementationPath(collection, collectionPath, name) {
    var _a, _b;
    const g = ((_a = collection.generators) === null || _a === void 0 ? void 0 : _a[name]) || ((_b = collection.schematics) === null || _b === void 0 ? void 0 : _b[name]);
    if (!g) {
...
function isAngularMigration(collection, collectionPath, name) {
    var _a, _b, _c, _d;
    const entry = ((_a = collection.generators) === null || _a === void 0 ? void 0 : _a[name]) || ((_b = collection.schematics) === null || _b === void 0 ? void 0 : _b[name]);
    ...
    const shouldBeNx = !!((_c = collection.generators) === null || _c === void 0 ? void 0 : _c[name]);
    const shouldBeNg = !!((_d = collection.schematics) === null || _d === void 0 ? void 0 : _d[name]);
...
const getNgCompatLayer = (() => {
    let _ngCliAdapter;
    return function getNgCompatLayer() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!_ngCliAdapter) {
                _ngCliAdapter = yield Promise.resolve().then(() => require('../adapter/ngcli-adapter'));

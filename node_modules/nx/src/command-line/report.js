...
const get_hashing_implementation_1 = require("../utils/get-hashing-implementation");
...
function reportHandler() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { pm, pmVersion, localPlugins, communityPlugins, packageVersionsWeCareAbout, outOfSyncPackageGroup, projectGraphError, currentHasherImplementation, } = yield getReportData();
        const bodyLines = [
...
function getReportData() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const currentHasherImplementation = (0, get_hashing_implementation_1.getHashingImplementation)();
        return {
            pm,
            pmVersion,
            localPlugins,
    ...
    for (const pkg of exports.packagesWeCareAbout) {
        ...
        if (v) {
            ...
            if (pkg.startsWith('@nrwl/')) {
                const otherPackage = (_a = packageChangeMap[pkg]) !== null && _a !== void 0 ? _a : pkg.replace('@nrwl/', '@nx/');
                ...
                const otherPackage = (_b = packageChangeMap[pkg]) !== null && _b !== void 0 ? _b : pkg.replace('@nx/', '@nrwl/');
                const otherVersion = packagesWeMayCareAbout[otherPackage];
                if (otherVersion && v === otherVersion) {
